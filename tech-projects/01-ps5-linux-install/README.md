...
## Relevant skills
- Firmware/exploit research and version-specific compatibility tracking
- Low-level system access and privilege escalation on closed hardware
- Documentation discipline under a process with real risk (bricking the device)

## Result
[Screenshot of Linux running, final state of the install]
